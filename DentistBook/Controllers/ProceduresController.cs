...
namespace DentistBook.Controllers
{
    public class ProceduresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProcedureID,Name")] Procedure procedure)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProcedureID,Name")] Procedure procedure)
        {
            if (ModelState.IsValid)
            {
